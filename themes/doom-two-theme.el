;;; doom-two-theme.el --- inspired by Atom One Dark -*- no-byte-compile: t; -*-
(require 'doom-themes)
...
(def-doom-theme doom-two
  ...
  ((bg         '("#282c34" nil       nil            ))
   ...
   (selection      dark-blue)
   (builtin        magenta)
   (comments       (if doom-two-brighter-comments dark-cyan base6))
   (doc-comments   (doom-lighten (if doom-two-brighter-comments dark-cyan base6) 0.25))
   (constants      violet)
   (functions      magenta)
   (keywords       blue)
   (methods        cyan)
   ...
   (-modeline-bright doom-two-brighter-modeline)
   (-modeline-pad
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if doom-two-comment-bg (doom-lighten bg 0.05)))
   (font-lock-doc-face
